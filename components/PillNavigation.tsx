          ...
          <div className="flex items-center justify-between max-w-6xl mx-auto">
            ...
            >
              <Link href="/" onClick={() => handleLinkClick("/")}>
                <motion.div
                  className="w-7 h-7 rounded-lg bg-gradient-to-br from-blue-500/20 to-purple-500/20 border border-blue-500/20 flex items-center justify-center backdrop-blur-sm"
                  whileHover={{ 
                    scale: 1.05,
                    rotate: [0, -2, 2, 0],
                    transition: { duration: 0.3 }
