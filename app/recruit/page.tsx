...
import { Crown, Users, Code, Palette, GraduationCap, Send, CheckCircle, AlertCircle } from "lucide-react"
            ...
            >
              ...
              <div className="space-y-4">
                <p className="text-muted-foreground">
                  In the meantime, join our Discord community to connect with other participants:
                </p>
                  ...
                  <Card
                    className={`h-full transition-all duration-300 ${
                      formData.role === role.value
                        ? "border-primary shadow-lg neon-glow"
                        : "border-border/50 hover:border-primary/30"
                    }`}
                  >
                    <CardContent className="p-4 text-center">
                      <div
                        className={`w-12 h-12 rounded-lg gradient-primary flex items-center justify-center mx-auto mb-3 ${
                          formData.role === role.value ? "neon-glow" : ""
                        }`}
                      >
                        <role.icon className="w-6 h-6 text-white" />
                      </div>
                      <h3 className={`font-semibold mb-2 ${role.color}`}>{role.label}</h3>
